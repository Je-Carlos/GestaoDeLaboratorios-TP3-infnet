...
namespace GestaoDeLaboratorios.Controllers
{
    public class ComputadoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Processador,PlacaMae,Memoria,HD,Patrimonio,DataCompra")] Computadores computadores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Processador,PlacaMae,Memoria,HD,Patrimonio,DataCompra")] Computadores computadores)
        {
